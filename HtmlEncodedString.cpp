...
#define MAX_ENTITY 254
static const struct QTextHtmlEntity { quint16 code; QString name; } entities[MAX_ENTITY]= {
	{ 34, "&quot;" },
	{ 37, "&percnt;" },
	{ 38, "&amp;" },
	{ 39, "&apos;" },
...
static bool operator<(const quint16 &code, const QTextHtmlEntity &entity)
{
    return code < entity.code;
}

static bool operator<(const QTextHtmlEntity &entity, const quint16& code)
{
...
HtmlEncodedString::HtmlEncodedString(const QString& text)
